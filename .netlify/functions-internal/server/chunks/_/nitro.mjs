...
const _assets = {
  ["nitro:bundled:cache:content:content-index.json"]: {
    ...
    meta: {"type":"application/json","etag":"\"2-vyGp6PvFo4RvsFtPoIWeCReyIC8\"","mtime":"2025-04-25T10:25:46.142Z"}
  },
  ["nitro:bundled:cache:content:content-navigation.json"]: {
    import: () => import('../raw/content-navigation.mjs').then(r => r.default || r),
    meta: {"type":"application/json","etag":"\"2-l9Fw4VUO7kr8CvBlt4zaMCqXZ0w\"","mtime":"2025-04-25T10:25:46.142Z"}
  }
};
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "0feb39aa-cffb-486e-9385-5804161f4749",
...
const _Je4dh9xdPsf4zFXy08WDA5Bhl9Y2vKXMWxNuD2yZQ = (function(nitro) {
...
const plugins = [
  _Je4dh9xdPsf4zFXy08WDA5Bhl9Y2vKXMWxNuD2yZQ
];
...
const _CRmgI_ = defineCachedEventHandler(async (event) => {
...
const _1vTWR9 = defineEventHandler(async (event) => {
...
const _ArkDL7 = defineEventHandler(async (event) => {
...
const _YVcPqm = defineEventHandler(async (event) => {
  const { getContentQuery } = await import('./query.mjs');
  const { cacheStorage, serverQueryContent } = await import('./storage.mjs').then(function (n) { return n.s; });
...
const _JPZWA_ = lazyEventHandler(() => {
...
const _lazy_aYOHMc = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_aYOHMc, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _CRmgI_, lazy: false, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _1vTWR9, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _1vTWR9, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _1vTWR9, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.1745576727791.json', handler: _ArkDL7, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _YVcPqm, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _YVcPqm, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _YVcPqm, lazy: false, middleware: false, method: "get" },
  { route: '/_ipx/**', handler: _JPZWA_, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_aYOHMc, lazy: true, middleware: false, method: undefined }
];
...
export { createHooks as A, getContext as B, toRouteMatcher as C, createRouter$1 as D, hasProtocol as E, withQuery as F, sanitizeStatusCode as G, isScriptProtocol as H, executeAsync as I, defuFn as J, klona as K, withTrailingSlash as L, withBase as M, kebabCase as N, getRequestHeader as O, setCookie as P, getCookie as Q, deleteCookie as R, parseQuery as S, parseURL as T, encodePath as U, encodeParam as V, createStorage as W, memoryDriver as X, useRuntimeConfig as a, buildAssetsURL as b, getResponseStatusText as c, getResponseStatus as d, defineRenderHandler as e, getQuery as f, getRouteRulesForPath as g, createError$1 as h, getRouteRules as i, joinHeaders as j, parseMarkdown as k, isRelative as l, destr as m, normalizeCookieHeader as n, camelCase as o, publicAssetsURL as p, joinURL as q, isPreview as r, prefixStorage as s, useStorage as t, useNitroApp as u, withoutTrailingSlash as v, withLeadingSlash as w, getPreview as x, defu as y, pascalCase as z };
