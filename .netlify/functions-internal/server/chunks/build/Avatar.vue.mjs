        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if (__props.src && !error.value) {
              ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(unref(_sfc_main$1)), mergeProps({
                role: "img",
                src: __props.src,
                alt: __props.alt,
                width: sizePx.value,
            ...
            return [
              __props.src && !error.value ? (openBlock(), createBlock(resolveDynamicComponent(unref(_sfc_main$1)), mergeProps({
                key: 0,
                role: "img",
                src: __props.src,
                alt: __props.alt,
