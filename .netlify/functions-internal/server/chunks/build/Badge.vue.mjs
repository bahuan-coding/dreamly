import { computed, unref, mergeProps, withCtx, renderSlot, createBlock, createCommentVNode, openBlock, toDisplayString, useSSRContext } from 'vue';
...
import { _ as _sfc_main$2 } from './Avatar.vue.mjs';
