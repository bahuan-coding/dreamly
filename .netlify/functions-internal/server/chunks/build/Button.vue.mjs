import { useSlots, ref, inject, computed, mergeProps, unref, withCtx, renderSlot, createBlock, createCommentVNode, openBlock, toDisplayString, createVNode, useSSRContext } from 'vue';
...
import { u as useButtonGroup, a as useComponentIcons } from './useButtonGroup.mjs';
import { o as omit } from './index.mjs';
import { t as tv } from './tv.mjs';
import { reactivePick } from '@vueuse/core';
import { _ as _sfc_main$3 } from './Icon.vue.mjs';
import { _ as _sfc_main$4 } from './Avatar.vue.mjs';
import { _ as _sfc_main$1, a as _sfc_main$2 } from './Link.vue.mjs';
  ...
  setup(__props) {
    ...
    const ui = computed(() => {
      ...
      return tv({
        ...
        }, ((_a = appConfig.ui) == null ? void 0 : _a.button) || {})
      })({
        color: props.color,
        ...
        default: withCtx(({ active, ...slotProps }, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$2, mergeProps(slotProps, {
              class: ui.value.base({
                class: [props.class, (_a2 = props.ui) == null ? void 0 : _a2.base],
                active,
                ...
                if (_push3) {
                  ...
                  return [
                    renderSlot(_ctx.$slots, "leading", {}, () => {
                      var _a3, _b2, _c;
                      return [
                        unref(isLeading) && unref(leadingIconName) ? (openBlock(), createBlock(_sfc_main$3, {
                          key: 0,
                          name: unref(leadingIconName),
                          class: ui.value.leadingIcon({ class: (_a3 = props.ui) == null ? void 0 : _a3.leadingIcon, active })
                    ...
                    renderSlot(_ctx.$slots, "trailing", {}, () => {
                      var _a3;
                      return [
                        unref(isTrailing) && unref(trailingIconName) ? (openBlock(), createBlock(_sfc_main$3, {
                          key: 0,
                          name: unref(trailingIconName),
                          class: ui.value.trailingIcon({ class: (_a3 = props.ui) == null ? void 0 : _a3.trailingIcon, active })
